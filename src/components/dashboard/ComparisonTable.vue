  ...
  <div v-if="!isEmpty(skuRefundRates) && !salesStore.isSkuRefundRatesLoading">
    <div class="relative w-96">
      <input
        ...
        placeholder="Search..."
        id="searchKey"
        class="w-full mb-4 px-4 py-3 border border-gray-100 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#5f28c7] transition duration-200 bg-white text-gray-700 placeholder-gray-500"
      />
      <button
        v-if="searchKey"
    ...
    >
      ...
      <template #date1="{ row }">
        <div
          class="whitespace-nowrap text-base font-normal justify-end"
      ...
      <template #date2="{ row }">
        <div
          class="whitespace-nowrap gap-x-1 text-base font-normal flex items-center date2 justify-end"
          :class="
